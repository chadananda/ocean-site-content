...
module.exports = function requestHandler(doc) {
  ...
  // Set basic variables
  let outputFolder = 'output/unauthorized-translations/'
  ...
  if (doc.url.match(/^https:\/\/bahai-library\.com\/Translations.*/)) {
    ...
    c.processLinks(doc, doc.$('a[href^="/Translations/"]'), requestHandler)
  }
    ...
    let meta = {
      ...
      collection: 'Unauthorized Translations (bahai-library.com)', // ?
